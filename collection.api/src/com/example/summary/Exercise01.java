...
public class Exercise01 {
	...
	public static void main(String[] args) {
		...
		// Collections.unmodifiableList(mutable list)
		// Collections.unmodifiableSet(mutable set)
		// Collections.unmodifiableMap(mutable map)
		var myList = List.of(4,8,15,16,23,42);
		var mySet = Set.of(4,8,15,16,23,42);
		var myMap = Map.of(
			"ankara", 312,
		...
		// Map: HashMap, LinkedHashMap, TreeMap, IdentityHashMap
		// Deque: ArrayDeque, ...
